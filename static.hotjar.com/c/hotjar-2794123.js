window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["survey.screenshots", "survey.embeddable_widget", "survey.type_button", "error_reporting", "survey.image_question", "feedback.widgetV2", "settings.billing_v2", "client_script.compression.pc", "ask.popover_redesign", "feedback.embeddable_widget"],
...
! function() {
    ...
    var n, i = function() {
        ...
        return r = t, (n = [{
            ...
            value: function(t) {
                var e = this;
                this.buffer.push(t), this.buffer.length >= this.batchSize ? this.flush() : this.flushTimer || (this.flushTimer = setTimeout((function() {
                    e.flush()
                }), this.flushInterval))
            }
        }, {
    ...
    var a, s, c = function() {
        ...
        d = function(t, e, r) {
            var n;
            l.loggedMetrics[t] = o(o({}, l.loggedMetrics[t]), {}, ((n = {})[e] = r || {}, n))
        },
        f = function(t) {
            if (!t) return "value";
        ...
        h = function(t) {
            var e, r = null !== (e = t.tag) && void 0 !== e ? e : void 0;
            return l.isDebugEnabled ? o(o(o({}, r), t.extraTags), l.genericTags) : r
        },
        g = function(t, e) {
            if (!a) return !1;
            var r = l.isMetricsEnabled || l.isDebugEnabled;
            return "lab" === t && (r = u.browser.inLab), "field" === t && (r = l.isFieldMetricsEnabled), e ? r && e.flush : r
        },
        b = function(t) {
            var e = !1,
                r = "v=".concat(u.version),
                n = "".concat(u.metricsUrl, "?").concat(r, "&site_id=").concat(window.hjSiteSettings.site_id) + (l.isDebugEnabled ? "&debug=true" : ""),
                i = JSON.stringify(t);
            ...
            u.browser.shouldLogMetrics && console.debug("New Metrics: ", t)
        },
        v = {
            ...
            start: function() {
                try {
                    ...
                    return l.genericTags = {
                        site_id: n
                    }, l.isDebugEnabled = Math.random() <= s.universalDebug || o.has("client_script.metrics.debug") && Math.random() <= s.debug, l.isMetricsEnabled = Math.random() <= s.metrics, l.isFieldMetricsEnabled = l.isMetricsEnabled && Math.random() <= s.fieldMetrics, a = new i(b, u.buffer.bufferSize, u.buffer.flushInterval), t
                } catch (t) {
            ...
            count: function(t, e) {
                ...
                try {
                    var c, u = f(n),
                        d = l.loggedMetrics[t],
                        b = 0;
                    if (r ? (b = (d && d[u] || 0) + (r.value || 1), l.loggedMetrics[t] = o(o({}, d), {}, ((c = {})[u] = null != r && r.flush ? 0 : b, c))) : b = 1, g(s, r)) {
                        var v = {
                            name: t,
                            type: "count",
                            value: b,
            ...
            timeIncr: function(t, e) {
                var r, n, i, o, a = e.tag,
                    ...
                    m = (r = t, {
                        tagName: n = f(a),
                        start: (o = (i = l.loggedMetrics[r]) && i[n] || {}).start,
                        total: o.total
                    }),
                    w = b ? b + (m.total || 0) : m.total;
                return d(t, m.tagName, {
                    total: w
                }), c && v.timeEnd(t, {
                    tag: a,
                    total: w,
            ...
            timeWatcher: function() {
                var t, e = 0,
                    ...
                    n = function() {
                        var r, n = v.time();
                        return e += null !== (r = t && n && n - t) && void 0 !== r ? r : 0, t = v.time(), e
                    };
                return {
                    start: function() {
                        if (!r) return r = !0, t = v.time()
                    },
                    incr: n,
                    end: function() {
                        var r = n();
        ...
        m = !(!window.CS_CONF || null === (s = window.CS_CONF.voc) || void 0 === s || !s.enabled);
    window.hj = window.hj || function() {
        for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++) e[r] = arguments[r];
        (window.hj.q = window.hj.q || []).push(e)
    }, window.hj.metrics = v;
    var w = hj.metrics.start();
    window.hjBootstrap = window.hjBootstrap || function(t, e, r) {
        ...
        d.async = 1, d.src = hj.scriptDomain + e, d.charset = "utf-8", l.appendChild(d), c.revision = "8502284", window.hjBootstrap = c
    }, window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.c9dc07351ea0d804fefa.js"
        },
        SURVEY_BOOTSTRAPPER: {
            js: "survey-bootstrapper.1db817a3108bf3677001.js"
        },
        SURVEY_ISOLATED: {
            js: "survey-isolated.ad3478587b74efc624dc.js"
        },
        HEATMAP_RETAKER: {
        ...
        PREACT_INCOMING_FEEDBACK: {
            js: "preact-incoming-feedback.8d825d8bb4192c0517a5.js"
        },
        SENTRY: {
        ...
        USER_TEST: {
            js: "user-test.6b13e219ddaceddb1094.js"
        }
    }, m ? window._uxa.push(["start:hotjar", window.hjSiteSettings]) : (window.hjBootstrap("https://script.hotjar.com/", "modules.e4b2dc39f985f11fb1e4.js", "2794123"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: w,
