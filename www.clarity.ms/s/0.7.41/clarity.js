/* clarity-js v0.7.41: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
    ...
    function A(t, e) {
        xi() && t && "string" == typeof t && t.length < 255 && (j = e && "string" == typeof e && e.length < 255 ? {
            key: t,
            value: e
        } : {
            value: t
    ...
    function B() {
        ...
        R = {
            gap: t - q
        }, xr(25), R.gap < 3e5 ? F = X(B, U) : Ni && (A("clarity", "suspend"), qi(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function et(t) {
        xi() && o.lean && (o.lean = !1, tt = {
            key: t
        }, Kr(), o.upgrade && o.upgrade(t), xr(3))
    }
    ...
    var ce = Object.freeze({
            ...
            add: function(t, e, n, a) {
                var r, i = Jt(t, !0),
                    ...
                    f = o.content ? 1 : 3;
                u >= 0 && Dt[u] && ((s = Dt[u]).children.push(i), l = null === l ? s.region : l, d = null === d ? s.metadata.fraud : d, f = s.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && ($e(t, n.attributes["data-clarity-region"]), l = i), It.set(i, t), Dt[i] = {
                        id: i,
                        parent: u,
                        previous: c,
                        children: [],
                ...
                if (r in Dt) {
                    ...
                    if (s.metadata.active = !0, s.previous !== o && (u = !0, s.previous = o), s.parent !== i) {
                        ...
                        if (s.parent = i, null !== i && i >= 0) {
                            ...
                            Dt[i].children.splice(d, 0, r), s.region = tn(t) ? r : Dt[i].region
                        } else ! function(t, e) {
                            if (t in Dt) {
                                var n = Dt[t];
    ...
    function me() {
        ...
        t && (fe = t, t.task().then((function() {
            ...
            t.id === Br() && (e && sr(0, 1, e.name, e.message, e.stack), fe = null, me())
        })))
    }
            ...
            return rt(this, (function(z) {
                switch (z.label) {
                    case 0:
                        ...
                        return [3, 12];
                    case 1:
                        return i = Ne, r.push(i.width), r.push(i.height), M(t, i.width, i.height), Za(r), [3, 12];
                    case 2:
                        for (u = 0, c = Be; u < c.length; u++) l = c[u], (r = [l.time, 7]).push(l.data.id), r.push(l.data.interaction), r.push(l.data.visibility), r.push(l.data.name), Za(r);
                        return on(), [3, 12];
                    case 3:
                        for (d = 0, f = Me; d < f.length; d++) b = f[d], (r = [b.time, b.event]).push(b.data.id), r.push(b.data.operation), r.push(b.data.newIds), Za(r);
                        for (h = 0, p = _e; h < p.length; h++) b = p[h], (r = [b.time, b.event]).push(b.data.id), r.push(b.data.operation), r.push(b.data.cssRules), Za(r);
                        return [3, 12];
                    case 4:
                        for (v = 0, g = Ie; v < g.length; v++) b = g[v], (r = [b.time, b.event]).push(b.data.id), r.push(b.data.operation), r.push(b.data.keyFrames), r.push(b.data.timing), r.push(b.data.timeline), r.push(b.data.targetId), Za(r);
                        return Pe(), [3, 12];
                    case 5:
                    ...
                    case 8:
                        ...
                        for (N = E.data, T = E.metadata.active, S = E.metadata.suspend, x = E.metadata.privacy, I = function(t) {
                            ...
                            if (N[j = C[D]]) switch (j) {
                                case "tag":
                                    A = Ue(E), R = I ? -1 : 1, r.push(E.id * R), E.parent && T && (r.push(E.parent), E.previous && r.push(E.previous)), r.push(S ? "*M" : N[j]), A && 2 === A.length && r.push("".concat("#").concat(Fe(A[0]), ".").concat(Fe(A[1])));
                                    break;
                                case "attributes":
                                    for (L in N[j]) void 0 !== N[j][L] && r.push(Ve(L, N[j][L], x));
                                    break;
                                case "value":
    ...
    function Dn(t, e, n) {
        ...
        if (i)
            for (var u = 0; u < i.length; u++) {
                ...
                l = l && a ? l + Math.round(a.offsetLeft) : l, d = d && a ? d + Math.round(a.offsetTop) : d, null !== l && null !== d && Cn({
                    time: o,
                    event: t,
                    data: {
                        target: Aa(n),
    ...
    function Cn(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && Mn.pop(), Mn.push(t), Y(_n), _n = X(jn, 500, t.event);
                break;
            default:
    ...
    function Un() {
        ...
        if (Hn) {
            var n = Ra(Hn, null);
            zr(31, null === (t = null == n ? void 0 : n.hash) || void 0 === t ? void 0 : t.join("."))
        }
        if (Pn) {
            var a = Ra(Pn, null);
            zr(32, null === (e = null == a ? void 0 : a.hash) || void 0 === e ? void 0 : e.join("."))
        }
    }
    var Fn = null,
        Vn = null,
    ...
    function oa(t) {
        ! function(t) {
            ...
            pi(t, "cut", wn.bind(this, 0), !0), pi(t, "copy", wn.bind(this, 1), !0), pi(t, "paste", wn.bind(this, 2), !0)
        }(t), function(t) {
            pi(t, "mousedown", In.bind(this, 13, t), !0), pi(t, "mouseup", In.bind(this, 14, t), !0), pi(t, "mousemove", In.bind(this, 12, t), !0), pi(t, "wheel", In.bind(this, 15, t), !0), pi(t, "dblclick", In.bind(this, 16, t), !0), pi(t, "touchstart", Dn.bind(this, 17, t), !0), pi(t, "touchend", Dn.bind(this, 18, t), !0), pi(t, "touchmove", Dn.bind(this, 19, t), !0), pi(t, "touchcancel", Dn.bind(this, 20, t), !0)
        }(t), function(t) {
            pi(t, "input", Nn, !0)
        }(t), function(t) {
            pi(t, "selectstart", Jn.bind(this, t), !0), pi(t, "selectionchange", Jn.bind(this, t), !0)
        }(t), function(t) {
            pi(t, "change", cn, !0)
        }(t), function(t) {
            pi(t, "submit", ta, !0)
    ...
    var ua = Object.freeze({
            ...
            observe: oa,
            start: function() {
                za = [], Pa(), bn(), kn(), An(), Sn(), pi(window, "resize", Rn), Rn(), pi(document, "visibilitychange", ra), ra(), zn = [], Xn(), Kn(), sn(), ea(), pi(window, "pagehide", na)
            },
            stop: function() {
                za = [], Pa(), bn(), kn(), Y(_n), Mn.length > 0 && jn(Mn[Mn.length - 1].event), Y(En), Sn(), Ln(), ia(), Y(Wn), zn = [], Hn = null, Pn = null, Kn(), Y(Bn), sn(), ea(), aa()
            }
        }),
        ca = /[^0-9\.]/g;
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "recipe":
                    ...
                    break;
                case "product":
                    zr(5, t[a]), zr(10, t.name), zr(12, t.sku), t.brand && zr(6, t.brand.name);
                    break;
                ...
                case "person":
                    ...
                    break;
                case "offer":
                    zr(7, t.availability), zr(14, t.itemCondition), zr(13, t.priceCurrency), zr(12, t.sku), W(13, la(t.price));
                    break;
                case "brand":
                    zr(6, t.name)
            }
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (o = t.parentElement ? t.parentElement : t.parentNode ? t.parentNode : null, "http://www.w3.org/2000/svg" === h.namespaceURI && (p = "svg:" + p), p) {
                    ...
                    case "IFRAME":
                        ...
                        Gt(T) && (! function(t) {
                            !1 === ae(t) && pi(t, "load", ja.bind(this, t, "childList"), !0)
    ...
    function ga(t) {
        ...
        try {
            ...
            if (sr(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
    ...
    function xa() {
        if (ba = [], Oa = [], Na = null, Ta = 0, Sa = {}, null === wa && (wa = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
            ...
            try {
                Element.prototype.attachShadow = function() {
                    return xi() ? Ca(Ea.apply(this, arguments)) : Ea.apply(this, arguments)
                }
            } catch (t) {
                Ea = null
            }
                        ...
                        switch (c = i.target, l = o.throttleDom ? function(t, e, n, a) {
                            ...
                            if (r && "HTML" !== r.data.tag) {
                                var i = a > Ta,
                                    ...
                                    c = [r.selector ? r.selector.join() : "", u, t.attributeName, Ia(t.addedNodes), Ia(t.removedNodes)].join();
                                Sa[c] = c in Sa ? Sa[c] : [0, n];
                                var s = Sa[c];
                                if (!1 === i && s[0] >= 10 && Da(s[2], 2, e), s[0] = i ? s[1] === n ? s[0] : s[0] + 1 : 1, s[1] = n, 10 === s[0]) return s[2] = t.removedNodes, "suspend";
                                if (s[0] > 10) return ""
                            }
                            return t.type
                            ...
                            case "characterData":
                                ...
                                break;
                            case "childList":
                                Da(i.addedNodes, 1, t, e.time), Da(i.removedNodes, 2, t, e.time);
                                break;
                            case "suspend":
    ...
    function Ca(t) {
        return Oa.indexOf(t) < 0 && Oa.push(t), Na && Y(Na), Na = X((function() {
            ! function() {
    ...
    function Aa(t) {
        ...
        return Ta = s() + 3e3, n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
        ...
        return void 0 === e && (e = null), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(Y) {
                switch (n = e || s(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = Mn; r < i.length; r++) W = i[r], (o = Ra(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(o.id), a.push(W.data.x), a.push(W.data.y), Za(a), M(W.event, W.data.x, W.data.y));
                        An();
                        break;
                    case 9:
                        for (u = 0, c = fn; u < c.length; u++) W = c[u], l = Ra(W.data.target, W.event, W.data.text), a = [W.time, W.event], d = l.hash ? l.hash.join(".") : "", a.push(l.id), a.push(W.data.x), a.push(W.data.y), a.push(W.data.eX), a.push(W.data.eY), a.push(W.data.button), a.push(W.data.reaction), a.push(W.data.context), a.push(m(W.data.text, "click", l.privacy)), a.push(b(W.data.link)), a.push(d), a.push(W.data.trust), Za(a), Wa(W.time, W.event, d, W.data.x, W.data.y, W.data.reaction, W.data.context);
                        bn();
                        break;
                    case 38:
                        for (f = 0, h = yn; f < h.length; f++) W = h[f], a = [W.time, W.event], (z = Ra(W.data.target, W.event)).id > 0 && (a.push(z.id), a.push(W.data.action), Za(a));
                        kn();
                        break;
                    case 11:
                        p = xn, a.push(p.width), a.push(p.height), M(t, p.width, p.height), Ln(), Za(a);
                        break;
                    case 26:
                        v = Zn, a.push(v.name), aa(), Za(a);
                        break;
                    case 27:
                        for (g = 0, y = On; g < y.length; g++) W = y[g], w = Ra(W.data.target, W.event, W.data.value), (a = [W.time, W.event]).push(w.id), a.push(m(W.data.value, "input", w.privacy)), Za(a);
                        Sn();
                        break;
                    case 21:
                        (k = Fn) && (E = Ra(k.start, t), O = Ra(k.end, t), a.push(E.id), a.push(k.startOffset), a.push(O.id), a.push(k.endOffset), Kn(), Za(a));
                        break;
                    case 10:
                        for (N = 0, T = zn; N < T.length; N++) W = T[N], S = Ra(W.data.target, W.event), x = Ra(W.data.top, W.event), _ = Ra(W.data.bottom, W.event), D = (null == x ? void 0 : x.hash) ? x.hash.join(".") : "", C = (null == _ ? void 0 : _.hash) ? _.hash.join(".") : "", S.id > 0 && ((a = [W.time, W.event]).push(S.id), a.push(W.data.x), a.push(W.data.y), a.push(D), a.push(C), Za(a), M(W.event, W.data.x, W.data.y, W.time));
                        zn = [], Hn = null, Pn = null;
                        break;
                    case 42:
                        for (j = 0, A = un; j < A.length; j++) W = A[j], a = [W.time, W.event], (z = Ra(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(z.id), a.push(W.data.type), a.push(m(W.data.value, "change", z.privacy)), a.push(m(W.data.checksum, "checksum", z.privacy)), Za(a));
                        sn();
                        break;
                    case 39:
                        for (R = 0, L = $n; R < L.length; R++) W = L[R], a = [W.time, W.event], (z = Ra(W.data.target, W.event)).id > 0 && (a.push(z.id), Za(a));
                        ea();
                        break;
                    case 22:
                        for (H = 0, P = Ha; H < P.length; H++) W = P[H], (a = [W.time, W.event]).push(W.data.type), a.push(W.data.hash), a.push(W.data.x), a.push(W.data.y), a.push(W.data.reaction), a.push(W.data.context), Za(a, !1);
                        Pa();
                        break;
                    case 28:
    ...
    function Wa(t, e, n, a, r, i, o) {
        void 0 === i && (i = 1), void 0 === o && (o = 0), za.push({
            time: t,
            event: 22,
            data: {
                type: e,
    ...
    var Xa, Ya, qa, Ua, Fa, Va = 0,
        Ba = 0,
        Ja = null,
        Ga = 0;

    function Ka() {
        Ua = !0, Va = 0, Ba = 0, Ga = 0, Xa = [], Ya = [], qa = {}, Fa = null
    }
    ...
    function Za(t, e) {
        if (void 0 === e && (e = !0), Ua) {
            ...
            n - Ga > 2 * i && (Y(Ja), Ja = null), e && null === Ja && (25 !== a && V(), Ja = X($a, i), Ga = n, _r(Ba))
        }
    }

    function Qa() {
        Y(Ja), $a(!0), Va = 0, Ba = 0, Ga = 0, Xa = [], Ya = [], qa = {}, Fa = null, Ua = !1
    }
    ...
    function $a(t) {
        return void 0 === t && (t = !1), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return Ja = null, (e = !1 === o.lean && Ba > 0 && (Ba < 1048576 || oi.sequence > 0)) && W(1, 1), en(),
                            function() {
                                var t = [];
                                Ha = [];
                                for (var e = oi.start + oi.duration, n = Math.max(e - 2e3, 0), a = 0, r = za; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && Ha.push(i), t.push(i))
                                }
                                za = t, La(22)
                            }(), kt(), n = !0 === t, a = JSON.stringify(si(n)), r = "[".concat(Ya.join(), "]"), i = e ? "[".concat(Xa.join(), "]") : "", u = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return P(2, (c = s) ? c.length : u.length), tr(u, c, oi.sequence, n), Ya = [], e && (Xa = [], Ba = 0, Va = 0), [2]
                }
            }))
        }))
    }
    ...
    function er(t, e) {
        var n = qa[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Ir(6) : (0 === t.status && (o.upload = o.fallback ? o.fallback : o.upload), tr(n.data, null, e)) : (Fa = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && xr(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (tr(n.data, null, e, !0), Ir(3)), t.status >= 200 && t.status <= 208 && nr(e), delete qa[e]))
    }
    ...
    function ir(t) {
        var e = t.error || t;
        return e.message in rr || (rr[e.message] = 0), rr[e.message]++ >= 5 || e && e.message && (ar = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function or(t) {
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(n) {
                switch (e = [s(), t], t) {
                    case 31:
                        e.push(ar.message), e.push(ar.line), e.push(ar.column), e.push(ar.stack), e.push(b(ar.source)), Za(e);
                        break;
                    case 33:
                        ur && (e.push(ur.code), e.push(ur.name), e.push(ur.message), e.push(ur.stack), e.push(ur.severity), Za(e, !1));
                        break;
                    case 41:
                        Et && (e.push(Et.id), e.push(Et.target), e.push(Et.checksum), Za(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function sr(t, e, n, a, r) {
        ...
        t in cr && cr[t].indexOf(i) >= 0 || (ur = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in cr ? cr[t].push(i) : cr[t] = [i], or(33))
    }
    var lr, dr = {},
        fr = new Set,
        hr = {},
    ...
    function br(t) {
        try {
            ...
            for (var o in hr[a] = {}, pr[a] = {}, vr[a] = {}, gr[a] = r, i) {
                var u = parseInt(o),
                    c = i[o],
                    s = 2;
            ...
            for (var t in hr) {
                ...
                if ("" == gr[e] || document.querySelector(gr[e])) {
                    ...
                    for (var u in o) {
                        ...
                        if (s) Er(e, c, Array.from(s).map((function(t) {
    ...
    function Er(t, e, n) {
        var a, r = !1;
        t in dr || (dr[t] = {}, r = !0), a = vr[t], 0 == Object.keys(a).length || e in dr[t] && dr[t][e] == n || (r = !0), dr[t][e] = n, r && fr.add(t)
    }
    ...
    function xr(t) {
        ...
        switch (t) {
            case 4:
                var n = N;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), e.push(n.data.scrollTime), Za(e, !1)), x();
                break;
            case 25:
                e.push(R.gap), Za(e);
                break;
    ...
    function _r(t) {
        if (0 === lr.check) {
            var e = lr.check;
            e = oi.sequence >= 128 ? 1 : e, e = oi.pageNum >= 128 ? 7 : e, e = s() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== lr.check && Ir(e)
        }
    }
    ...
    function zr(t, e) {
        e && (e = "".concat(e), t in jr || (jr[t] = []), jr[t].indexOf(e) < 0 && (jr[t].push(e), t in Ar || (Ar[t] = []), Ar[t].push(e), jr[t].length > 128 && Ir(5)))
    }
    ...
    function Ur() {
        ...
        var n, a = function() {
                ...
                if (e) {
                    var n = e.split("|");
                    n.length >= 5 && t.ts - ti(n[1]) < 18e5 && (t.session = n[0], t.count = ti(n[2]) + 1, t.upgrade = ti(n[3]), t.upload = n.length >= 6 ? "".concat("https://").concat(n[5], "/").concat(n[4]) : "".concat("https://").concat(n[4]))
                }
                return t
            }(),
            r = ei(),
        ...
        Wr = {
            ...
            sessionId: a.session,
            pageNum: a.count
        }, o.lean = o.track && null !== a.upgrade ? 0 === a.upgrade : o.lean, o.upload = o.track && "string" == typeof o.upload && a.upload && a.upload.length > "https://".length ? a.upload : o.upload, zr(0, t), zr(3, e), zr(1, b(location.href, !!Yr)), zr(2, document.referrer), zr(15, function() {
            var t = $r();
            ...
            var e;
            zr(22, t.platform), zr(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                zr(24, t.name + "~" + t.version)
            })), zr(25, t.model), W(27, t.mobile ? 1 : 0)
        })) : zr(22, navigator.platform)), screen && (W(14, Math.round(screen.width)), W(15, Math.round(screen.height)), W(16, Math.round(screen.colorDepth)));
    ...
    function Jr(t) {
        if (void 0 === t && (t = !0), !t) return o.track = !1, ri("_clsk", "", -Number.MAX_VALUE), ri("_clck", "", -Number.MAX_VALUE), qi(), void window.setTimeout(Yi, 250);
    ...
    function Kr() {
        var t = Math.round(Date.now()),
            ...
            n = o.lean ? 0 : 1;
        ! function(t) {
            Xr.length > 0 && Xr.forEach((function(e) {
                !e.callback || e.wait && !t || e.callback(Wr, !o.lean)
            }))
        }(n), ri("_clsk", [Wr.sessionId, t, Wr.pageNum, n, e].join("|"), 1)
    }
    ...
    function Qr(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e || t.dob !== a) && ri("_clck", [Wr.userId, 2, n.toString(36), e, a].join("|"), 365)
    }
    ...
    function ei() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 1 && (t.version = ti(n[1])), n.length > 2 && (t.expiry = ti(n[2], 36)), n.length > 3 && 1 === ti(n[3]) && (t.consent = 1), n.length > 4 && ti(n[1]) > 1 && (t.dob = ti(n[4])), o.track = o.track || 1 === t.consent, t.id = o.track ? n[0] : t.id
        }
        return t
    }
            ...
            if (n)
                for (var a = 0; a < n.length; a++) {
                    ...
                    if (r.length > 1 && r[0] && r[0].trim() === t) {
                        for (var i = ai(r[1]), o = i[0], u = i[1]; o;) o = (e = ai(u))[0], u = e[1];
                        return u
                    }
                }
        }
    ...
    function ri(t, e, n) {
        if ((o.track || "" == e) && (navigator && navigator.cookieEnabled || Zr(document, "cookie"))) {
            var a = function(t) {
            ...
            try {
                if (null === qr) {
                    for (var c = location.hostname ? location.hostname.split(".") : [], s = c.length - 1; s >= 0; s--)
                        if (qr = ".".concat(c[s]).concat(qr || ""), s < c.length - 1 && (document.cookie = "".concat(u).concat(";").concat("domain=").concat(qr), ni(t) === e)) return;
                    qr = ""
                }
            } catch (t) {
                qr = ""
            }
            document.cookie = qr ? "".concat(u).concat(";").concat("domain=").concat(qr) : u
        }
    }
    var ii, oi = null;
    ...
    function si(t) {
        return oi.start = oi.start + oi.duration, oi.duration = s() - oi.start, oi.sequence++, oi.upload = t && "sendBeacon" in navigator ? 1 : 0, oi.end = t ? 1 : 0, [oi.version, oi.sequence, oi.start, oi.duration, oi.projectId, oi.userId, oi.sessionId, oi.pageNum, oi.upload, oi.end]
    }
    ...
    function pi(t, e, n, a) {
        void 0 === a && (a = !1), n = fi(n);
        try {
            t[u("addEventListener")](e, n, a), hi.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function Ti() {
        Ni = !0, c = performance.now() + performance.timeOrigin, ve(), vi(), li(), bi = Oi(), yi = 0, pi(window, "popstate", ki), null === gi && (gi = history.pushState, history.pushState = function() {
            gi.apply(this, arguments), xi() && wi() && ki()
        }), null === mi && (mi = history.replaceState, history.replaceState = function() {
    ...
    var Ci = Object.freeze({
        ...
        hashText: $t,
        start: function() {
            Se(), xe(), on(), Qe = null, Je = new WeakMap, Ge = {}, Ke = [], Ze = !!window.IntersectionObserver, Ut(), o.delayDom ? pi(window, "load", (function() {
                xa()
            })) : xa(), ge(Di, 1).then((function() {
                fi(xe)(), fi(en)(), fi(Un)()
            })), window.Animation && window.KeyframeEffect && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Pe(), Xe(Ce, "play"), Xe(je, "pause"), Xe(Ae, "cancel"), Xe(Re, "finish"), null === De && (De = Element.prototype.animate, Element.prototype.animate = function() {
        ...
        Ai = {
            ...
            function(t) {
                at(this, void 0, void 0, (function() {
                    var e, n;
                    return rt(this, (function(a) {
                        return e = s(), n = [e, t], 29 === t && (n.push(Ai.fetchStart), n.push(Ai.connectStart), n.push(Ai.connectEnd), n.push(Ai.requestStart), n.push(Ai.responseStart), n.push(Ai.responseEnd), n.push(Ai.domInteractive), n.push(Ai.domComplete), n.push(Ai.loadEventStart), n.push(Ai.loadEventEnd), n.push(Ai.redirectCount), n.push(Ai.size), n.push(Ai.type), n.push(Ai.protocol), n.push(Ai.encodedSize), n.push(Ai.decodedSize), Ri(), Za(n)), [2]
                    }))
                }))
            }(29)
    }
    var zi = ["navigation", "resource", "longtask", "first-input", "layout-shift", "largest-contentful-paint"];
    ...
    function Hi() {
        try {
            ...
            for (var t = 0, e = zi; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && P(9, 0), ji.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        zr(4, Wi(r)), r !== o.upload && r !== o.fallback || W(28, a.duration);
                        break;
                    case "longtask":
                        H(7);
                        break;
    ...
    var Xi = [Ii, Ci, ua, Object.freeze({
        __proto__: null,
        start: function() {
            Ri(),
                function() {
                    navigator && "connection" in navigator && zr(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? pi(window, "load", X.bind(this, Hi, 0)) : Hi() : sr(3, 0)
                }()
        },
        stop: function() {
        ...
        void 0 === t && (t = null),
            function() {
                try {
                    ...
                    return !1 === Ni && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap && !t
                } catch (t) {
                    return !1
                }
            }() && (Mi(t), Ti(), yt(), Xi.forEach((function(t) {
                return fi(t.start)()
            })), null === t && Bi())
    }

    function qi() {
        xi() && (Xi.slice().reverse().forEach((function(t) {
            return fi(t.stop)()
        })), wt(), Si(), void 0 !== Fi && (Fi[Vi] = function() {
            (Fi[Vi].q = Fi[Vi].q || []).push(arguments), "start" === arguments[0] && Fi[Vi].q.unshift(Fi[Vi].q.pop()) && Bi()
        }))
    }
    var Ui = Object.freeze({
            ...
            metadata: Vr,
            pause: function() {
                xi() && (A("clarity", "pause"), null === he && (he = new Promise((function(t) {
                    pe = t
                }))))
            },
            resume: function() {
                xi() && (he && (pe(), he = null, null === fe && me()), A("clarity", "resume"))
            },
            set: ot,
            signal: function(t) {
                gt = t
    ...
    function Bi() {
        if (void 0 !== Fi) {
            if (Fi[Vi] && Fi[Vi].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = Fi[Vi] && Fi[Vi].q || [];
            for (Fi[Vi] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return Ui[t].apply(Ui, e)
                }, Fi[Vi].v = l; t.length > 0;) Fi[Vi].apply(Fi, t.shift())
        }
    }
    Bi()
}();