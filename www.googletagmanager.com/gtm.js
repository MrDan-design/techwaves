...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_uniqueTriggerId": "66253219_3",
                "vtp_enableTriggerStartOption": true,
                "tag_id": 10
            }, {
                "function": "__html",
                "once_per_event": true,
                "vtp_html": "\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,e,b,f,g,c,d){a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};c=e.createElement(f);c.async=1;c.src=\"https:\/\/www.clarity.ms\/tag\/\"+g+\"?ref\\x3dgtm2\";d=e.getElementsByTagName(f)[0];d.parentNode.insertBefore(c,d)})(window,document,\"clarity\",\"script\",\"fylssu1y0f\");\u003C\/script\u003E",
            ...
            "predicates": [{
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "https:\/\/techwave.net\/enterprise-application\/sap-cx-services\/"
            }, {
                "function": "_eq",
                "arg0": ["macro", 1],
    ...
    */
    ...
    ii.ie = Number("0") || 0;
    ii.Ya = "dataLayer";
    ii.fn = "ChEI8MDttAYQhrSKwd3+rrrbARIkAK9oXAkOUKd5l99B/gPFDhhwEcccFNdHrQzOr0yYW9J7KjCPGgJymA\x3d\x3d";
    var ki = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var tk;
    try {
        tk = JSON.parse(jb("eyIwIjoiTkciLCIxIjoiTkctRkMiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jb20ubmciLCI0IjoiIiwiNSI6dHJ1ZSwiNiI6ZmFsc2UsIjciOiJhZF9zdG9yYWdlfGFuYWx5dGljc19zdG9yYWdlfGFkX3VzZXJfZGF0YXxhZF9wZXJzb25hbGl6YXRpb24ifQ"))
    } catch (a) {
        P(123), sk(2), tk = {}
    }
    ...
    var zr = function(a, b) {
            W(5) && (a.dma = Rn(), Sn() && (a.dmaCps = Qn()), Fn(b) ? a.npa = "0" : a.npa = "1")
        },
        Br = function(a, b, c) {
            if (H[a.functionName]) return b.Bh && J(b.Bh), H[a.functionName];
            var d = Ar();
            H[a.functionName] = d;
            if (a.zf)
                for (var e = 0; e < a.zf.length; e++) H[a.zf[e]] = H[a.zf[e]] || Ar();
            a.Df && H[a.Df] === void 0 && (H[a.Df] = c);
            Dc(yr("https://", "http://", a.Mh), b.Bh, b.mm);
            return d
        },
        Ar = function() {
            var a = function() {
        ...
        Fr = {
            ...
            zf: [Dr.functionName, Cr.functionName],
            Mh: "www.gstatic.com/call-tracking/call-tracking_" + (Er.kk || Er.Sk) + ".js"
        },
        Gr = {},
        ...
        Ir = function(a, b, c, d, e) {
            ...
            if (b && c) {
                ...
                for (var f = {
                    ...
                    var k = a[g];
                    Gr[k.id] || (k && k.prefix === "AW" && !f.adData && k.ma.length >= 2 ? (f.adData = {
                        ak: k.ma[ol[1]],
                        cl: k.ma[ol[2]]
                    }, zr(f.adData, d), Gr[k.id] = !0) : k && k.prefix === "UA" && !f.gaData && (f.gaData = {
                        gaWpid: k.ia
                    }, Gr[k.id] = !0))
        ...
        Kr = function(a, b) {
            if (a)
                if (Vn()) {} else if (a = z(a) ? ll(Tj(a)) : ll(Tj(a.id))) {
                var c = void 0,
                    d = !1,
                    e = T(b, Q.g.Pi);
    ...
    var Vr = function(a) {
        ...
        Ur = function() {
            var a = I.body,
                ...
                c, d;
            if (I.compatMode && I.compatMode !== "BackCompat") c = b ? b.clientHeight : 0, d = b ? b.clientWidth : 0;
            else {
                var e = function(f, g) {
    ...
    var Oy = function() {
            (ji.rm = ji.rm || {})[Pj()] = function(a) {
                if (Ny.hasOwnProperty(a)) return Ny[a]
            }
        },
        Ry = function(a, b, c) {
            if (a instanceof Py) {
        ...
        Py = function(a) {
            ...
            this.resolve = function(b) {
                for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === My ? b : a[d]);
                return c.join("")
            }
        };
    Py.prototype.toString =
        function() {
    ...
    var gD = function(a, b) {
                    ...
                    e = function(f) {
                        ...
                        if (c.isGtmEvent || kD(b, n.createOnlyFields)) {
                            ...
                            d && X(Q.g.U) && (d = !1, m(function() {
                                var t = ww().getByName(c.isGtmEvent ? g : b);
        ...
        vD = function(a, b, c) {
            function d() {
                var L = T(c, Q.g.Vc);
                k(function() {
                    if (!c.isGtmEvent && Wa(L)) {
                        var S = u.fieldsToSend,
                            V = m().getByName(n),
                            ca;
                        for (ca in L)
                            if (L[ca] != void 0 && /^(dimension|metric)\d+$/.test(ca)) {
                                var ba = V.get(fD(L[ca]));
                                nD(S, ca, ba)
                            }
                    }
                })
            ...
            var f = a,
                g, k = c.isGtmEvent ? xw(T(c, "gaFunctionName")) : xw();
            if (pb(k)) {
                var m = ww,
                    n;
                c.isGtmEvent ?
                ...
                var p = function(L) {
                    ...
                    q = function(L) {
                        var S = function(ma, ia) {
                                for (var ya = 0; ia && ya < ia.length; ya++) p(ma, ia[ya])
                            },
                            V = c.isGtmEvent,
                            ca = V ? oD(u) : pD(b, c);
                        if (ca) {
                            ...
                            V && ca.Vg && p("set", "&cu", ca.Vg);
                            var R = ca.action;
                            if (V || R === "impressions")
                                if (S("ec:addImpression", ca.Jj), !V) return;
                            if (R === "promo_click" || R === "promo_view" || V && ca.Me) {
                                var oa =
                                    ca.Me;
                                S("ec:addPromo", oa);
                            ...
                            R !== "promo_view" && R !== "impressions" && (S("ec:addProduct", ca.Ic), p("ec:setAction", R, ca.ub))
                        }
                    },
                    r = function(L) {
                        if (L) {
                            var S = {};
                            if (Wa(L))
                                for (var V in qD) qD.hasOwnProperty(V) && rD(qD[V], V, L[V], S);
                            mD(S, y);
                            p("require", "linkid", S)
                        }
                    },
                ...
                if (!c.isGtmEvent && u.createOnlyFields[Q.g.pb] || w) {
                    var x = ej(c.isGtmEvent ? u.fieldsToSet[Q.g.pb] : u.createOnlyFields[Q.g.pb], "/analytics.js");
                    x && (g = x)
                }
        ...
        yD = function(a) {
            ...
            for (var c = [], d = 0; a && d < a.length; d++) a[d] && Wa(a[d]) && c.push(b(a[d]));
    ...
    var uD, sD = {},
        iD = {},
        BD = {},
        CD = Object.freeze((BD.page_hostname = 1, BD[Q.g.ka] = 1, BD[Q.g.kb] = 1, BD[Q.g.Va] = 1, BD[Q.g.Wa] = 1, BD[Q.g.ab] = 1, BD[Q.g.rc] = 1, BD[Q.g.Fb] = 1, BD[Q.g.Oa] = 1, BD[Q.g.sc] = 1, BD[Q.g.wa] = 1, BD[Q.g.fd] = 1, BD[Q.g.Da] = 1, BD[Q.g.Kb] =
            1, BD)),
        DD = {},
        dD = Object.freeze((DD.client_storage = "storage", DD.sample_rate = 1, DD.site_speed_sample_rate = 1, DD.store_gac = 1, DD.use_amp_client_id = 1, DD[Q.g.lb] = 1, DD[Q.g.ra] = "storeGac", DD[Q.g.Va] = 1, DD[Q.g.Wa] = 1, DD[Q.g.ab] = 1, DD[Q.g.rc] = 1, DD[Q.g.Fb] = 1, DD[Q.g.sc] = 1, DD)),
        ED = {},
        FD = Object.freeze((ED._cs = 1, ED._useUp = 1, ED.allowAnchor = 1, ED.allowLinker = 1, ED.alwaysSendReferrer = 1, ED.clientId = 1, ED.cookieDomain = 1, ED.cookieExpires = 1, ED.cookieFlags = 1, ED.cookieName = 1, ED.cookiePath = 1, ED.cookieUpdate = 1, ED.legacyCookieDomain =
            1, ED.legacyHistoryImport = 1, ED.name = 1, ED.sampleRate = 1, ED.siteSpeedSampleRate = 1, ED.storage = 1, ED.storeGac = 1, ED.useAmpClientId = 1, ED._cd2l = 1, ED)),
        GD = Object.freeze({
            anonymize_ip: 1
        }),
        HD = {},
        eD = Object.freeze((HD.campaign = {
            ...
            }, HD.app_id = 1, HD.app_installer_id = 1, HD.app_name = 1, HD.app_version = 1, HD.description = "exDescription", HD.fatal = "exFatal", HD.language = 1, HD.page_hostname = "hostname",
            HD.transport_type = "transport", HD[Q.g.za] = "currencyCode", HD[Q.g.sg] = 1, HD[Q.g.wa] = "location", HD[Q.g.fd] = "page", HD[Q.g.Da] = "referrer", HD[Q.g.Kb] = "title", HD[Q.g.df] = 1, HD[Q.g.Ba] = 1, HD)),
        ID = {},
        JD = Object.freeze((ID.content_id = 1, ID.event_action = 1, ID.event_category = 1, ID.event_label = 1, ID.link_attribution = 1, ID.name = 1, ID[Q.g.sa] = 1, ID[Q.g.rg] = 1, ID[Q.g.Ja] = 1, ID[Q.g.na] = 1, ID)),
        KD = Object.freeze({
            displayfeatures: 1,
            enableLinkId: 1,
            enableRecaptcha: 1,
        ...
        LD = {},
        qD = Object.freeze((LD.levels = 1, LD[Q.g.Wa] = "duration", LD[Q.g.rc] = 1, LD)),
        MD = {},
        ND = Object.freeze((MD.anonymize_ip = 1, MD.fatal = 1, MD.send_page_view = 1, MD.store_gac = 1, MD.use_amp_client_id = 1, MD[Q.g.ra] = 1, MD[Q.g.sg] = 1, MD)),
        rD = function(a, b, c, d) {
            if (c !== void 0)
                if (ND[b] && (c = yb(c)), b !== "anonymize_ip" ||
        ...
        OD = {},
        tD = Object.freeze((OD.checkout_progress = 1, OD.select_content = 1, OD.set_checkout_option = 1, OD[Q.g.mc] = 1, OD[Q.g.nc] = 1, OD[Q.g.Sb] = 1, OD[Q.g.oc] = 1, OD[Q.g.hb] = 1, OD[Q.g.Db] = 1, OD[Q.g.ib] = 1, OD[Q.g.Ia] = 1, OD[Q.g.qc] = 1, OD[Q.g.Na] = 1, OD)),
        PD = {},
        QD = Object.freeze((PD.checkout_progress = 1, PD.set_checkout_option =
            1, PD[Q.g.Sf] = 1, PD[Q.g.Tf] = 1, PD[Q.g.mc] = 1, PD[Q.g.nc] = 1, PD[Q.g.Uf] = 1, PD[Q.g.Sb] = 1, PD[Q.g.Ia] = 1, PD[Q.g.qc] = 1, PD[Q.g.Vf] = 1, PD)),
        RD = {},
        SD = Object.freeze((RD.generate_lead = 1, RD.login = 1, RD.search = 1, RD.select_content = 1, RD.share = 1, RD.sign_up = 1, RD.view_search_results = 1, RD[Q.g.oc] = 1, RD[Q.g.hb] = 1, RD[Q.g.Db] = 1, RD[Q.g.ib] = 1, RD[Q.g.Na] = 1, RD)),
        TD = function(a) {
            var b = "general";
            QD[a] ? b = "ecommerce" : SD[a] ? b = "engagement" : a === "exception" && (b = "error");
            return b
        },
        UD = {},
        VD = Object.freeze((UD.view_search_results = 1, UD[Q.g.hb] = 1,
            UD[Q.g.ib] = 1, UD[Q.g.Na] = 1, UD)),
        nD = function(a, b, c) {
        ...
        jD = function(a, b, c) {
            ...
            for (var r = !c.isGtmEvent, t = Fl(c), u = 0; u < t.length; ++u) {
                ...
                if (c.isGtmEvent) {
                    var w = d(v);
                    KD.hasOwnProperty(v) ? e[v] = w : FD.hasOwnProperty(v) ? k[v] = w : g[v] = w
                } else {
                    var x = void 0;
                    x = v !== Q.g.la ? d(v) : Gl(c, v);
                    if (JD.hasOwnProperty(v)) rD(JD[v], v, x, e);
                    else if (GD.hasOwnProperty(v)) rD(GD[v], v, x, g);
                        ...
                        var B = void 0,
                            A = void 0;
                        b === Q.g.ba ? B = Mb(Gl(c, v), ".") : (B = Mb(Gl(c, v, 1), "."), A = Mb(Gl(c, v, 2), "."));
                        B && (f["&gdid"] = B);
                        A && (f["&edid"] = A)
                    } else v === Q.g.Oa && t.indexOf(Q.g.rc) < 0 && (k.cookieName = x + "_ga");
                    W(92) && CD[v] && (c.H.hasOwnProperty(v) || b === Q.g.ba && c.j.hasOwnProperty(v)) && (r = !1)
                }
            }
            W(92) && r && (f["&jsscut"] = "1");
            d(Q.g.Te) !== !1 && d(Q.g.kb) !==
            ...
            !c.isGtmEvent && d(Q.g.Xa) && (k._useUp = !0);
            if (c.isGtmEvent) {
                ...
                nD(g, "forceSSL", !0);
                nD(e, "eventCategory", TD(b));
                VD[b] && nD(f, "nonInteraction", !0);
                b === "login" || b === "sign_up" || b === "share" ? nD(e, "eventLabel", d(Q.g.rg)) : b === "search" || b === "view_search_results" ? nD(e, "eventLabel", d(Q.g.Ri)) : b === "select_content" &&
                    nD(e, "eventLabel", d(Q.g.xi));
                var E = e[Q.g.sa] || {},
                    D = E[Q.g.Ac];
                D || D != 0 && E[Q.g.W] ? k.allowLinker = !0 : D === !1 && nD(k, "useAmpClientId", !1);
                f.hitCallback = c.onSuccess;
                k.name = a
            }
            Gn() && (g["&gcs"] = Hn());
            g["&gcd"] = Pn(c);
            Rk() && (X(Q.g.U) || (k.storage = "none"), X([Q.g.P, Q.g.O]) || (g.allowAdFeatures = !1, k.storeGac = !1));
            Sn() && (g["&dma_cps"] = Qn());
            g["&dma"] = Rn();
            kn(sn()) && (g["&tcfd"] = Tn());
            Bi.j && (g["&tag_exp"] = Bi.j);
            var F = gj(c) || d(Q.g.pb),
                M = d(Q.g.Ud);
            F && (c.isGtmEvent || (k[Q.g.pb] = F), k._cd2l = !0);
            M && !c.isGtmEvent && (k[Q.g.Ud] =
                M);
            e.fieldsToSend = f;
            e.fieldsToSet = g;
        ...
        oD = function(a) {
            ...
            if (b.impressions) {
                ...
                var d = b.impressions;
                c.Jj = b.translateIfKeyEquals === "impressions" ? yD(d) : d
            }
            if (b.promoView) {
                c.action = "promo_view";
                var e = b.promoView.promotions;
                c.Me = b.translateIfKeyEquals === "promoView" ? yD(e) : e
            }
            if (b.promoClick) {
            ...
            for (var g in b)
                if (b[g] !== void 0 && g !== "translateIfKeyEquals" && g !== "impressions" && g !== "promoView" && g !== "promoClick" && g !== "currencyCode") {
                    c.action = g;
                    var k = b[g].products;
                    c.Ic = b.translateIfKeyEquals === "products" ? yD(k) : k;
        ...
        pD = function(a, b) {
            ...
            else if (a === "select_content" || a === Q.g.oc) q = {
                action: "click",
                ub: {
    ...
    Z.securityGroups.sdl = ["google"],
        function() {
            ...
            function b(A) {
                for (var C = [], E = A.split(","), D = 0; D < E.length; D++) {
                    var F = Number(E[D]);
                    if (isNaN(F)) return [];
                    r.test(E[D]) || C.push(F)
                }
            ...
            function f() {
                var A = B(),
                    C = A.Wg,
                    E = A.Xg,
                    D = C / x.scrollWidth * 100,
                    F = E / x.scrollHeight *
                    100;
                e(C, "horiz.pix", t.xf, u.aj);
                e(D, "horiz.pct", t.wf, u.aj);
                e(E, "vert.pix", t.xf, u.zj);
                e(F, "vert.pct", t.wf, u.zj);
                pz("sdl", "pending", !1)
            }

            function g(A, C) {
                oz("sdl", "init", !1) && !a() && (C ? Ic(v, "scrollend", A) : Ic(v, "scroll", A), Ic(v, "resize", A), pz("sdl", "init", !1))
            }

            function k() {
                var A = 250,
                    C = !1;
                w.scrollingElement && w.documentElement && v.addEventListener && (A = 50, C = !0);
                var E = 0,
                    D = !1,
                    F = function() {
                        D ? E = BI(F, A) : (E = 0, f(), g(M));
                        D = !1
                    },
                    M = function() {
                        C && B();
                        E ? D = !0 : (E = BI(F, A), pz("sdl", "pending", !0))
                    };
                return M
            }
            ...
            function q(A) {
                ...
                var C = A.vtp_uniqueTriggerId,
                    E = A.vtp_horizontalThresholdsPixels,
                    D = A.vtp_horizontalThresholdsPercent,
                ...
                oz("sdl", "init", !1) ? oz("sdl", "pending") || (y || (d(), y = !0), J(function() {
                    return f()
                })) : (d(), y = !0, x && (pz("sdl", "init", !0), pz("sdl", "pending", !0), J(function() {
                    f();
                    if (a()) {
                        var S = k();
                        "onscrollend" in v ? (S = m(), Hc(v, "scrollend", S)) : Hc(v, "scroll", S);
                        Hc(v, "resize", S)
                    } else pz("sdl", "init", !1)
                })))
            }
            ...
            (function(A) {
                ...
                A.vtp_triggerStartOption ? q(A) : Wx(function() {
                    q(A)
                })
            })
        }();
    ...
    Z.securityGroups.ua = ["google"],
        function() {
            ...
            function b(n) {
                var p = {};
                n.vtp_gaSettings && l(rI(n.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), p);
                l(rI(n.vtp_fieldsToSet, "fieldName", "value"), p);
            ...
            function e(n, p) {
                if (!f && (!Bi.D && !qi || !p._x_19 || n.vtp_useDebugVersion || n.vtp_useInternalVersion)) {
                    ...
                    var r = n.vtp_gtmOnFailure,
                        t = ej(p._x_19, "/analytics.js"),
                        u = yr("https:", "http:", "//www.google-analytics.com/" + q, p && !!p.forceSSL);
                    CI(q === "analytics.js" && t ? t : u, function() {
                        var v = ww();
                        v && v.loaded ||
                            r();
                    }, r)
            ...
            var f, g = {
                ...
                m = function(n) {
                    ...
                    if (n.vtp_gaSettings) {
                        ...
                        l(rI(u.vtp_contentGroup, "index", "group"), q);
                        l(rI(u.vtp_dimension, "index", "dimension"), r);
                        l(rI(u.vtp_metric, "index", "metric"), t);
                        var v = l(u);
                    ...
                    l(rI(n.vtp_contentGroup, "index", "group"), q);
                    l(rI(n.vtp_dimension, "index", "dimension"), r);
                    l(rI(n.vtp_metric, "index", "metric"), t);
                    var w = b(n),
                    ...
                    var C = function(ma, ia) {
                        for (var ya in ia) ia.hasOwnProperty(ya) && (w[ma + ya] = ia[ya])
                    };
                    C("contentGroup", q);
                    C("dimension", r);
                    C("metric", t);
                    ...
                    if (n.vtp_trackType === "TRACK_EVENT") y = "track_event", p(), w.eventCategory = String(n.vtp_eventCategory), w.eventAction = String(n.vtp_eventAction), w.eventLabel = c(String, n.vtp_eventLabel),
                        ...
                        if (y = Q.g.Tb, p(), n.vtp_advertisingFeaturesType == "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" && (w.remarketingLists = !0), n.vtp_autoLinkDomains) {
                            var E = {};
                    ...
                    var F = Tl(Sl(Rl(Ql(Jl(new Il(n.vtp_gtmEventId, n.vtp_gtmPriorityId),
            ...
            function b(d) {
                if (I.body) {
                    var e = d.vtp_gtmOnFailure,
                        f = Ry(d.vtp_html, d.vtp_gtmOnSuccess, e),
                        g = f.Hj,
                        k = f.onSuccess;
                    if (d.vtp_useIframe) {} else d.vtp_supportDocumentWrite ? c(g, k, e) : a(I.body, Lc(g), k, e)()
                } else BI(function() {
                    b(d)
                }, 200)
            }
    ...
    var JI = {};
    JI.onHtmlSuccess = Sy(!0), JI.onHtmlFailure = Sy(!1);
    JI.dataLayer = Ji;
    ...
    (function(a) {
        ...
        try {
            ...
            if (Cj().canonical[a]) {
                ...
                a: {}
                Bi.j =
                "95250752";Bi.D = Bi.H;Bi.K = "";Bi.Z = "ad_storage|analytics_storage|ad_user_data|ad_personalization";Bi.R = "ad_storage|analytics_storage|ad_user_data";Bi.Qa = "";Zv();
